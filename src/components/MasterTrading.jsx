        ...
        <div className="grid grid-cols-[.9fr_1fr] gap-20 items-center max-xl:gap-14 max-lg:gap-9 max-lg:grid-cols-1">
          ...
          >
            ...
            <motion.h2
              ...
              className={`text-[50px] leading-tight font-semibold tracking-[-0.5px] max-lg:text-4xl ${mode === "dark" ? "text-white" : "text-dark1f"}`}
            >
            ...
            <motion.p
              ...
              className={`text-sm leading-[1.71] mx-auto mt-[10px] ${mode === "dark" ? "text-ivoryTint" : "text-dark1f opacity-80"}`}
            >
          ...
          >
            <motion.div
              ...
              className={`relative h-full p-8 rounded-[18px] border border-solid border-[rgba(255,255,255,0.10)] flex flex-col gap-8 ${mode === "dark" ? "bg-card-radial" : "bg-white"}`}
            ...
            >
              <div className="flex items-center justify-between w-full font-inter">
                ...
                <span className={`text-[12px] font-bold relative h-8 max-w-max flex items-center justify-center gap-2 rounded-[100px] py-[14px] px-5 border-solid border border-[rgba(255,204,0,0.10)] shadow-[0px_4px_10px_0px_rgba(0,0,0,0.00)_inset] ${mode === "dark" ? "bg-[rgba(255,204,0,0.10)] text-[#fc0]" : "bg-[rgba(31,31,31,0.10)] text-dark1f"}`}>
                  Success
                </span>
              </div>
              <motion.div 
              ...
              >
                <span className={`opacity-60 text-sm ${mode === "dark" ? "text-ivoryTint" : "text-dark1f"}`}>
                  Current Progress
                </span>
                <div className="flex justify-between items-center mt-4">
                  ...
                  <span className="text-[28px] leading-tight font-semibold">
                    80%
                    <span className={`opacity-60 text-sm font-normal ms-1 ${mode === "dark" ? "text-ivoryTint" : "text-dark1f"}`}>
                      Complete
                    </span>
                  </span>
                </div>
                <ProgressBar
                  key={inView ? "progress-main" : "progress-main-init"}
                  ...
                  completedClassName={`${inView ? "w-[70%]" : "w-[70%]"}  h-[10px] rounded-[100px] ${mode === "dark" ? "bg-[#fc0] " : "bg-dark1f"}`}
              ...
              >
                <div className={`p-4 rounded-[10px] border border-[rgba(255,255,255,0.10)] ${mode === "dark" ? "bg-[rgba(5,5,5,0.40)]" : "bg-[#F1F1F1]"}`}>
                  ...
                  <ProgressBar
                    key={inView ? "progress-second" : "progress-second-init"}
                ...
                <div className={`p-4 rounded-[10px] border border-[rgba(255,255,255,0.10)] ${mode === "dark" ? "bg-[rgba(5,5,5,0.40)]" : "bg-[#F1F1F1]"}`}>
                  ...
                  <ProgressBar
                    key={inView ? "progress-third" : "progress-third-init"}
                    completed={inView ? 60 : 0}
                    className={`rounded-[100px] ${mode === "dark" ? "bg-[rgba(255,255,255,0.10)]" : "bg-[rgba(31,31,31,0.10)]"}`}
                    barContainerClassName="rounded-[100px] h-[6px] mt-2.5"
                    completedClassName={`w-[60%] h-[6px] rounded-[100px] ${mode === "dark" ? "bg-[#fc0] " : "bg-dark1f"}`}
